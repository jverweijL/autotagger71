...
public class EditBusinessruleMVCActionCommand extends BaseMVCActionCommand {
    @Override
    protected void doProcessAction(
            ActionRequest actionRequest, ActionResponse actionResponse)
            throws Exception {

        System.out.printf("id: %s, tagname: %s, rule: %s\n",ParamUtil.getString(actionRequest, "id"),
                                                            ParamUtil.getString(actionRequest, "tagname"),
                                                            ParamUtil.getString(actionRequest, "businessrule"));
        ...
        _autotaggingService.Update(ParamUtil.getString(actionRequest, "id"),
                                   ParamUtil.getString(actionRequest, "tagname"),
                                   ParamUtil.getString(actionRequest, "businessrule"));
